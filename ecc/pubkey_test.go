...
func Test_PublicKeyMarshalUnmarshal(t *testing.T) {
	cases := []struct {
		...
		{
			name: 			 "SM2",
			key: 				 "PUB_SM2_6fcQT3xRrnHF1VynNek98tREFbtU9aZEnU3REwats9DeR6r61L",
			expectedKey: "PUB_SM2_6fcQT3xRrnHF1VynNek98tREFbtU9aZEnU3REwats9DeR6r61L",
		},
	}
...
func TestPublicKey_MarshalJSON(t *testing.T) {
	cases := []struct {
		...
		},
		{
			name:					"SM2",
			key:					"PUB_SM2_6fcQT3xRrnHF1VynNek98tREFbtU9aZEnU3REwats9DeR6r61L",
			expectedJSON: `"PUB_SM2_6fcQT3xRrnHF1VynNek98tREFbtU9aZEnU3REwats9DeR6r61L"`,
		},
	}

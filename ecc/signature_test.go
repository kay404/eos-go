...
func TestSignatureSerialization(t *testing.T) {
	...
	// fmt.Printf("privKey is %v \n", privkey.inner.string())
	privkey, err := NewPrivateKey("PVT_SM2_2e1nizZJz3fMnv5aXVqY32zUMNpGaoh3GsDiJNHHHoxsdNmrW9")
	...
	require.NoError(t, err)
	assert.Equal(t, `PUB_SM2_81rXvdE8WEFSneYEKkENpEBZ24aZ2Sb2TEUZVznhW3SSS834JU`, pubKey.String()) // not checked after..
